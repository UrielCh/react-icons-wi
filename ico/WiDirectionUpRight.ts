...
/**
 * DirectionUpRight icon from Weather Icons
 * @module
 */
export function WiDirectionUpRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiDirectionUpRight;
