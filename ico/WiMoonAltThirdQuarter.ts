...
/**
 * MoonAltThirdQuarter icon from Weather Icons
 * @module
 */
export function WiMoonAltThirdQuarter(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltThirdQuarter;
