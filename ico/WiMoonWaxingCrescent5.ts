...
/**
 * MoonWaxingCrescent5 icon from Weather Icons
 * @module
 */
export function WiMoonWaxingCrescent5(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaxingCrescent5;
