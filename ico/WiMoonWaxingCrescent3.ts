...
/**
 * MoonWaxingCrescent3 icon from Weather Icons
 * @module
 */
export function WiMoonWaxingCrescent3(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaxingCrescent3;
