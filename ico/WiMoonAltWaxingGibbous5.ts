...
/**
 * MoonAltWaxingGibbous5 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaxingGibbous5(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaxingGibbous5;
