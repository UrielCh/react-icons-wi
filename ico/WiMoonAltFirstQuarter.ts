...
/**
 * MoonAltFirstQuarter icon from Weather Icons
 * @module
 */
export function WiMoonAltFirstQuarter(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltFirstQuarter;
