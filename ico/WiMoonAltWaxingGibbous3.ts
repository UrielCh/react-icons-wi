...
/**
 * MoonAltWaxingGibbous3 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaxingGibbous3(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaxingGibbous3;
