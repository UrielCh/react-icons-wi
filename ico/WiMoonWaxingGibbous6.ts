...
/**
 * MoonWaxingGibbous6 icon from Weather Icons
 * @module
 */
export function WiMoonWaxingGibbous6(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaxingGibbous6;
