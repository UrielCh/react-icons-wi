...
/**
 * MoonAltWaxingCrescent4 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaxingCrescent4(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaxingCrescent4;
