...
/**
 * MoonAltWaningGibbous2 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaningGibbous2(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaningGibbous2;
