...
/**
 * MoonAltWaxingGibbous2 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaxingGibbous2(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaxingGibbous2;
