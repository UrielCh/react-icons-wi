...
/**
 * MoonThirdQuarter icon from Weather Icons
 * @module
 */
export function WiMoonThirdQuarter(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonThirdQuarter;
