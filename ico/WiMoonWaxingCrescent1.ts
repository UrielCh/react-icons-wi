...
/**
 * MoonWaxingCrescent1 icon from Weather Icons
 * @module
 */
export function WiMoonWaxingCrescent1(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaxingCrescent1;
