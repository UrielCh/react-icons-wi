...
/**
 * MoonAltWaxingCrescent3 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaxingCrescent3(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaxingCrescent3;
