...
/**
 * MoonWaxingGibbous4 icon from Weather Icons
 * @module
 */
export function WiMoonWaxingGibbous4(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaxingGibbous4;
