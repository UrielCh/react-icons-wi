...
/**
 * MoonWaxingGibbous2 icon from Weather Icons
 * @module
 */
export function WiMoonWaxingGibbous2(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaxingGibbous2;
