...
/**
 * MoonAltWaningGibbous3 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaningGibbous3(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaningGibbous3;
