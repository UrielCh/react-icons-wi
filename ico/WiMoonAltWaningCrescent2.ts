...
/**
 * MoonAltWaningCrescent2 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaningCrescent2(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaningCrescent2;
