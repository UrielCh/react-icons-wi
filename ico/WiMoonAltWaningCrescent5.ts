...
/**
 * MoonAltWaningCrescent5 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaningCrescent5(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaningCrescent5;
