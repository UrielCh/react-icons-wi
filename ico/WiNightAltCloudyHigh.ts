...
/**
 * NightAltCloudyHigh icon from Weather Icons
 * @module
 */
export function WiNightAltCloudyHigh(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiNightAltCloudyHigh;
