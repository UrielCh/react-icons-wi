...
/**
 * MoonAltWaxingCrescent2 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaxingCrescent2(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaxingCrescent2;
