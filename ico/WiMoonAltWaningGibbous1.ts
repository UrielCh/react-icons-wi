...
/**
 * MoonAltWaningGibbous1 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaningGibbous1(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaningGibbous1;
