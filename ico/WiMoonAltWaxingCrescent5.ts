...
/**
 * MoonAltWaxingCrescent5 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaxingCrescent5(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaxingCrescent5;
