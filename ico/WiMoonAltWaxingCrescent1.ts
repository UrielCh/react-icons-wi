...
/**
 * MoonAltWaxingCrescent1 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaxingCrescent1(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaxingCrescent1;
