...
/**
 * MoonWaningGibbous2 icon from Weather Icons
 * @module
 */
export function WiMoonWaningGibbous2(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaningGibbous2;
