...
/**
 * MoonWaxingCrescent2 icon from Weather Icons
 * @module
 */
export function WiMoonWaxingCrescent2(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaxingCrescent2;
