...
/**
 * MoonAltWaxingGibbous6 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaxingGibbous6(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaxingGibbous6;
