...
/**
 * MoonWaningGibbous3 icon from Weather Icons
 * @module
 */
export function WiMoonWaningGibbous3(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaningGibbous3;
