...
/**
 * DirectionDownRight icon from Weather Icons
 * @module
 */
export function WiDirectionDownRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiDirectionDownRight;
