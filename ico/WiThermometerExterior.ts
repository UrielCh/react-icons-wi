...
/**
 * ThermometerExterior icon from Weather Icons
 * @module
 */
export function WiThermometerExterior(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiThermometerExterior;
