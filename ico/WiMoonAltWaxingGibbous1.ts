...
/**
 * MoonAltWaxingGibbous1 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaxingGibbous1(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaxingGibbous1;
