...
/**
 * MoonAltWaningCrescent6 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaningCrescent6(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaningCrescent6;
