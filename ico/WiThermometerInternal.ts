...
/**
 * ThermometerInternal icon from Weather Icons
 * @module
 */
export function WiThermometerInternal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiThermometerInternal;
