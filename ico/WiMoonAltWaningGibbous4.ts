...
/**
 * MoonAltWaningGibbous4 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaningGibbous4(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaningGibbous4;
