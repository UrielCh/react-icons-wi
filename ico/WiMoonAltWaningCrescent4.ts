...
/**
 * MoonAltWaningCrescent4 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaningCrescent4(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaningCrescent4;
