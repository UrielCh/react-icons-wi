...
/**
 * MoonWaningCrescent5 icon from Weather Icons
 * @module
 */
export function WiMoonWaningCrescent5(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaningCrescent5;
