...
/**
 * MoonAltWaningCrescent1 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaningCrescent1(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaningCrescent1;
