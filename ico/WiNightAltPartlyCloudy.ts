...
/**
 * NightAltPartlyCloudy icon from Weather Icons
 * @module
 */
export function WiNightAltPartlyCloudy(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiNightAltPartlyCloudy;
