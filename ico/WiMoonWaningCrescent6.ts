...
/**
 * MoonWaningCrescent6 icon from Weather Icons
 * @module
 */
export function WiMoonWaningCrescent6(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaningCrescent6;
