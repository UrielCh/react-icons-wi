...
/**
 * MoonWaningGibbous1 icon from Weather Icons
 * @module
 */
export function WiMoonWaningGibbous1(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaningGibbous1;
