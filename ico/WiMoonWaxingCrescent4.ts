...
/**
 * MoonWaxingCrescent4 icon from Weather Icons
 * @module
 */
export function WiMoonWaxingCrescent4(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaxingCrescent4;
