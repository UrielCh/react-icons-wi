...
/**
 * MoonAltWaningGibbous6 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaningGibbous6(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaningGibbous6;
