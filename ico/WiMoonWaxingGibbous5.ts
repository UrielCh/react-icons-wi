...
/**
 * MoonWaxingGibbous5 icon from Weather Icons
 * @module
 */
export function WiMoonWaxingGibbous5(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaxingGibbous5;
