...
/**
 * MoonAltWaxingGibbous4 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaxingGibbous4(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaxingGibbous4;
