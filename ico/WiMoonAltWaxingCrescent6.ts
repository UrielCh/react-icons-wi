...
/**
 * MoonAltWaxingCrescent6 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaxingCrescent6(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaxingCrescent6;
