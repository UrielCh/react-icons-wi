...
/**
 * MoonWaxingGibbous1 icon from Weather Icons
 * @module
 */
export function WiMoonWaxingGibbous1(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonWaxingGibbous1;
