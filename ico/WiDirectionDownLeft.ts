...
/**
 * DirectionDownLeft icon from Weather Icons
 * @module
 */
export function WiDirectionDownLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiDirectionDownLeft;
