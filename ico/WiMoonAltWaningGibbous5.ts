...
/**
 * MoonAltWaningGibbous5 icon from Weather Icons
 * @module
 */
export function WiMoonAltWaningGibbous5(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiMoonAltWaningGibbous5;
