...
/**
 * NightPartlyCloudy icon from Weather Icons
 * @module
 */
export function WiNightPartlyCloudy(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default WiNightPartlyCloudy;
